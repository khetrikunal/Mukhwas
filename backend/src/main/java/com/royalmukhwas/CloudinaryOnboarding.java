...
public class CloudinaryOnboarding {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Use only APIs available in cloudinary-http44:1.34.0.
        // This SDK does not support Transformation.format(...) or autoGeneratedFormat(...).
        // Instead, generate the transformation using the transformation string.
